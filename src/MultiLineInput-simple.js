...
// Initialize log file
try {
  fs.writeFileSync(inputLogFile, `=== Simple MultiLineInput logging started at ${new Date().toISOString()} ===\n`);
} catch (error) {
  // Fail silently
}

/**
 * SIMPLE Multi-line text input - fully controlled by parent
 * No internal state = No race conditions!
 */
